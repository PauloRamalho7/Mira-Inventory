...
"MSWin32-x64-multi-thread-10.0.20348.707" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.20348.707) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAETIMEDOUT WSAEALREADY WSAEREFUSED WSAEPFNOSUPPORT WSAEOPNOTSUPP
	WSAEACCES WSAENOMORE WSAEINVALIDPROVIDER WSAEDQUOT WSAENOBUFS
	WSAEHOSTDOWN WSAEREMOTE WSAENOTEMPTY WSAEHOSTUNREACH
	WSAEINVALIDPROCTABLE WSAENOPROTOOPT WSAEPROCLIM WSAEINVAL
	WSAEINPROGRESS WSAENETDOWN WSAENAMETOOLONG WSAENOTSOCK WSAESTALE
	WSAEDISCON WSAECANCELLED WSAENOTCONN WSAECONNREFUSED WSAEADDRNOTAVAIL
	WSAEWOULDBLOCK WSAETOOMANYREFS WSAEBADF WSAENETRESET
	WSAESOCKTNOSUPPORT WSAEMSGSIZE WSAENETUNREACH WSAEISCONN WSAEPROTOTYPE
	WSAEAFNOSUPPORT WSAEPROVIDERFAILEDINIT WSAECONNRESET WSAEUSERS
	WSAEINTR WSAESHUTDOWN WSAEFAULT WSAEDESTADDRREQ WSAELOOP WSAEMFILE
	WSAECONNABORTED WSAEADDRINUSE WSAEPROTONOSUPPORT
    )],
);
